...
const Form__RiskRegisterProcess_MakerSubmitRR: React.FC<any> = (props: any) => {
		...
		<div className={'pf-v5-c-form'}>
				...
				<CardBody className='pf-v5-c-form'>
					...
					<FormGroup
						...
						<TextInput
							...
							placeholder={''}
							type={'text'}
							value={approval__comment}
							onChange={(e, newValue) => set__approval__comment(newValue)}
						/>
					</FormGroup>
					<FormGroup
						...
						label={'Date'}
						isRequired={false}>
						<Flex direction={{ default: 'column' }} id={'uniforms-0002-0004'}>
							<FlexItem>
								<InputGroup style={{ background: 'transparent' }}>
									<DatePicker
										id={'date-picker-uniforms-0002-0004'}
										isDisabled={false}
										name={'approval.date'}
										onChange={(e, newDate) => {
											set__approval__date((prev) => {
												if (newDate) {
										...
										value={parseDate(approval__date)}
									/>
									<TimePicker
										id={'time-picker-uniforms-0002-0004'}
										isDisabled={false}
										name={'approval.date'}
			...
			<Card>
				<CardBody className='pf-v5-c-form'>
								...
								<div
									...
									<div style={{ width: '100%', marginRight: '10px' }}>
										<Card>
											<CardBody className='pf-v5-c-form'>
												<FormGroup
													fieldId={'uniforms-0002-001h'}
													label={'Comment'}
													isRequired={false}>
													<TextInput
														name={`approvalLog__approvals.${itemIndex}.comment`}
														id={'uniforms-0002-001h'}
														isDisabled={true}
														placeholder={''}
														type={'text'}
												...
												<FormGroup
													fieldId={'uniforms-0002-001j'}
													label={'Date'}
													isRequired={false}>
													<Flex
														direction={{ default: 'column' }}
														id={'uniforms-0002-001j'}>
														<FlexItem>
															<InputGroup style={{ background: 'transparent' }}>
																<DatePicker
																	id={'date-picker-uniforms-0002-001j'}
																	isDisabled={true}
																...
																/>
																<TimePicker
																	id={'time-picker-uniforms-0002-001j'}
																	isDisabled={true}
																	name={`approvalLog__approvals.${itemIndex}.date`}
																	onChange={(e, time, hours?, minutes?) =>
																		set__approvalLog__approvals((prev) => {
												...
												<FormGroup
													fieldId={'uniforms-0002-001k'}
													label={'Status'}
													isRequired={false}>
													<TextInput
														name={`approvalLog__approvals.${itemIndex}.status`}
														id={'uniforms-0002-001k'}
														isDisabled={true}
														placeholder={''}
														type={'text'}
												...
												<FormGroup
													fieldId={'uniforms-0002-001l'}
													label={'User id'}
													isRequired={false}>
													<TextInput
														name={`approvalLog__approvals.${itemIndex}.userId`}
														id={'uniforms-0002-001l'}
														isDisabled={true}
														placeholder={''}
														type={'text'}
					...
					<FormGroup
						fieldId={'uniforms-0002-001m'}
						label={'Final status'}
						isRequired={false}>
						<TextInput
							name={'approvalLog.finalStatus'}
							id={'uniforms-0002-001m'}
							isDisabled={true}
							placeholder={''}
							type={'text'}
...
export default Form__RiskRegisterProcess_MakerSubmitRR;
